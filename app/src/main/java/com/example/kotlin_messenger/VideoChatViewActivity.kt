...
class VideoChatViewActivity : AppCompatActivity() {
    ...
    private val mRtcEventHandler: IRtcEngineEventHandler = object : IRtcEngineEventHandler() {
        ...
        override fun onJoinChannelSuccess(
            ...
            runOnUiThread(Runnable { Log.i(TAG,"Join channel success, uid: " + (uid)) })
        }
        ...
        override fun onFirstRemoteVideoDecoded(
            ...
            runOnUiThread(Runnable {
                Log.i(TAG,"First remote video decoded, uid: " + (uid))
    ...
    private fun setupRemoteVideo(uid: Int) {
        ...
        /*
          ...
          calling SurfaceView.
         */var mRemoteView = RtcEngine.CreateRendererView(getBaseContext())
    ...
    private fun showSampleLogs() {
        ...
        Log.i(TAG,"You will see custom logs here")
        Log.i(TAG,"You can also use this to show errors")
    }
    ...
    fun setupLocalVideo() {
        ...
        var mLocalView = RtcEngine.CreateRendererView(getBaseContext())
